    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        Workflow:
            ...
            4. Load state_dict (reports missing/unexpected keys when strict=False)
        ...
        Args:
            ...
            strict: If True, raise error on key mismatch. If False, warn and continue.
        ...
        if strict:
            ...
            if missing_keys:
                logger.warning(
                    f"Missing keys in state_dict ({len(missing_keys)}): "
                    f"they will use their default initialisation."
                )
            if unexpected_keys:
                logger.warning(
                    f"Unexpected keys in state_dict ({len(unexpected_keys)}): "

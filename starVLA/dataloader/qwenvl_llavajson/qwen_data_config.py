...
def data_list(dataset_names, data_root_dir=None):
    ...
    for dataset_name in dataset_names:
        ...
        if dataset_name in data_dict.keys():
            ...
            if data_root_dir is not None:
                config["annotation_path"] = os.path.join(data_root_dir, "llava_jsons", os.path.basename(config["annotation_path"]))
                config["data_path"] = os.path.join(data_root_dir, "images") + "/"

...
source_model_id=${source_model_id:-/mnt/nas/gezuhao/zhouyuchen/playground/Pretrained_models/Qwen3-VL-2B-Instruct}
target_model_id=${target_model_id:-/mnt/nas/gezuhao/zhouyuchen/playground/Pretrained_models/Qwen3-VL-2B-Instruct-Action}

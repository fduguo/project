...
starVLA_PYTHON=/mnt/nas/gezuhao/zhouyuchen/miniconda3/envs/starVLA/bin/python
ROBOCASA_PYTHON=/mnt/nas/gezuhao/zhouyuchen/miniconda3/envs/robocasa_new/bin/python
export PYTHONPATH=$(pwd):${PYTHONPATH}
CKPT_DEFAULT="/mnt/nas/gezuhao/zhouyuchen/playground/Checkpoints/checkpoints/steps_90000_pytorch_model.pt"

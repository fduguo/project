...
class PolicyServerWrapper:
    ...
    def __init__(
        ...
        framework = baseframework.from_pretrained(self._ckpt_path, strict=False)
        if use_bf16:
    ...
    def predict_action(
        ...
        **kwargs,
        ...
        print(f"DEBUG unnorm actions: min={unnorm.min():.3f}, max={unnorm.max():.3f}, mean={unnorm.mean():.3f}")
